...
<html <?php language_attributes(); ?>>
  <head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-KJ9G4TZMV5"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());
	  gtag('config', 'G-KJ9G4TZMV5');
	</script>
                ...
                <div class="row align-items-center ">
                    <div class="col-xl-3 col-lg-3 col-md-11 col-9">
						...
						<div class="landing-page_navbar__lang-switches">
							<ul>
								<li><a class="active" href=https://qaptum.com>EN</a></li>
								<li><a href=https://qaptum.com/es>ESP</a></li>
							</ul>
						</div>		
                    ...
                    <div class="col-xl-7 col-lg-7 d-none d-xl-block">
                        <div class="main-menu">
                            <nav id="mobile-menu">
                                <ul>
                                    <li><a href="<?php echo site_url('/usecases'); ?>" >Use Cases <!--<i class="fa fa-angle-down"></i>--></a>
                                    ...
                                    <li><a href="<?php echo site_url('/whyus'); ?>">Why Qaptum</a></li>
    ...
    <aside class="slide-bar">
        ...
        <nav class="side-mobile-menu">
            <ul id="mobile-menu-active">
				<li><a href="<?php echo site_url('/usecases'); ?>">Use Cases</a>
                <!-- <li class="has-dropdown">
                    <a href="<?php echo site_url('/usecases'); ?>">Use Cases</a> -->
                    <!-- <ul class="sub-menu">
                ...
                <!-- <li class="has-dropdown"><a href="<?php echo site_url('/products'); ?>">Products</a>
                    <ul class="sub-menu">
                        <li><a href="#">1</a>
                        <li><a href="#">2</a>
                        <li><a href="#">3</a>
