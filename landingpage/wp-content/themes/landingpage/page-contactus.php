                    ...
                    <div class="col-xl-6 col-lg-6 col-md-9 pt-40">
                        <div class="hero-content  mt-30">
                            <div class="hero-slider-caption">
                                ...
                                <h1 class="text-black pb-20 fw-bold side-line">Contact Us</h1>
                                <p class="text-muted">Want to increase your brand value, fill out the form below for a quick demo of Qaptum.</p>
                            </div>
                        </div>
                    </div>
