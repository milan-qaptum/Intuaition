                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class=" price-card">
                            <div class="card-body">
                                ...
                                <div class="text-center"><a href="<?php echo site_url('/contactanos'); ?>"><button class="access_btns">Contact Us</button></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3">
											...
											<thead class="d-sm-none stiky-head">
												<tr>
													...
													<div class="price-card mobile-card">
														...
														<div class="cost">USD $2,799/month</div>
														<div class="text-center">
															<a href="<?php echo site_url('/contactanos'); ?>"><button class="access_btns">Contact Us</button></a>
														</div>
														</div>
													</div>
													</th>
